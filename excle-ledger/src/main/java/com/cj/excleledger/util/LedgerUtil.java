package com.cj.excleledger.util;
...
public class LedgerUtil {
     ...
     * @return
     */
    public static Map getNameAndNum1(ApiResult apiResult,String br,int k){
        ...
        FindExcleStruByStIdAndTabNameResp info1 = (FindExcleStruByStIdAndTabNameResp) apiResult.getData();
        if (info1 != null){
            List<ExcleTableStructure> list2 = info1.getExcleTableStructures();//获取表结构
            List<TableCellRecord> list3 = info1.getTableCellRecords();//获取表数据
            if (list2!=null){
    ...
    public static Map getNameAndNum2(ApiResult apiResult,String br,int k){
        List<ExcleTableStructure> structureList1 = new ArrayList<>();
        List<ExcleTableStructure> structureList2 = new ArrayList<>();
        StringBuffer sb1 = new StringBuffer();//风险物质
        StringBuffer sb2 = new StringBuffer();//最大储存量/t
